...
class PackedBed:
    ...
    def temperatureProfile(self, L, diameter, time, m_f, T_in, T0, d = 0.0015, epsilon = 0.04):
        ...
        #L = 1.6 #input length of packed bed
        #diameter = 0.13 #length to diameter ratio of 5:1
        #time = 600 #simulation time in seconds 
        #m_f = 0.02 #mass flow rate of fluid entering bed

        #T0 = 75 #initial temperature of packed bed 
        #T_in = 290 #temperature of fluid entering packed bed

        #epsilon = 0.4 #void fraction
        #d = 0.0015 #particle diameter

        rho_f = 1.225 #fluid density
        kf = 0.02476 #fluid thermal conductivity
        cf = 1000 #fluid cp (was 700)

        rho_s = 1800 #solid density
        ks = 6 #solid thermal conductivity
        cs = 541 #solid heat capacity (cp)
    ...
    #INPUTS: 
    #fluid, material
    #length, diameter, simulation time, mass flowrate, fluid temperature, packed bed temperature, particle diameter = 0.0015, 
